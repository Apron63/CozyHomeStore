...
final class DownloadController extends AbstractController
{
    ...
    #[Route('/cabinet/pharma_statistic/list_goods/download/', name: 'cabinet_pharma_statistic_list_goods_download')]
    public function __invoke(Request $request): Response
    {
        ...
        $content = $this->reportService->getGoodslist($reportPeriod, $user, $manufacturer);

        $filename = null === $manufacturer
            ? 'Список номенклатуры ' . $manufacturer . ' ' .  $reportPeriod . '.xlsx'
            : 'Список номенклатуры.xlsx';
